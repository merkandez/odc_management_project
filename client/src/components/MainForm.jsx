...
const MainForm = ({
    ...
    const validateMinor = () => {
        ...
        if (age <= 0 || age > 14) {
            setErrorMessage(
                'La edad del menor debe ser igual o menor a 14 años'
            )
            return false
        }
    ...
    const validateAdult = () => {
        ...
        if (age < 15) {
            setErrorMessage(
                'La edad del adulto debe ser igual o mayor a 15 años'
            )
            return false
        }
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row">
                        <div className="w-full sm:w-1/2">
                            ...
                            <Select
                                ...
                                onChange={(option) =>
                                    handleGenderChange(option, 'main')
                                }
                        ...
                        <div className="mt-6">
                            ...
                            {(formData.minors || []).length < 3 ? (
                                ...
                                <p className="mt-4 text-sm text-red-500">
                                    Límite máximo de menores inscritos
                                    alcanzado.
                                </p>
                            )}
                            {minorError && (
