        ...
        <table className="w-full mb-4 border-collapse">
          <thead>
            <tr className="border-b-2 border-orange">
              <th className="p-3 text-left font-helvetica-w20-bold">Nombre</th>
              <th className="p-3 text-left font-helvetica-w20-bold">Email</th>
              <th className="p-3 text-left font-helvetica-w20-bold">Curso</th>
