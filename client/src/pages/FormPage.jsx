...
const FormPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4">
      ...
      <div
        className="hidden lg:block flex-wrap lg:flex-nowrap lg:gap-4 p-4 m-4 border-orange w-full max-w-[1200px] bg-cover bg-center"
      ...
      <div className="lg:hidden w-full max-w-[1200px] p-4 m-4 border-orange">
        {/* Formulario sin imagen de fondo */}
        <div className="w-full bg-white bg-opacity-90 p-4 shadow-lg">
          <MainForm
            courseId={id}
            setIncludeMinor={setIncludeMinor}
            includeMinor={includeMinor}
